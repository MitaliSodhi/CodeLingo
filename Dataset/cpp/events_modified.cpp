...
//  events_modified.cpp (c) 2002 Kari Laitinen
...
int main()
{
   ...
   list_of_events.insert( event_on_list,
        Event( 30, 7, 1947, "Arnold Schwarzenegger was born." ) ) ;

   event_on_list  ++  ;

   list_of_events.insert( event_on_list,
        Event( 26, 7, 1943, "Mick Jagger was born." ) ) ;
   list_of_events.insert( event_on_list,
        Event( 16, 8, 1958, "Madonna was born." ) ) ;
   list_of_events.insert( event_on_list,
        Event( 27,11, 1942, "Jimi Hendrix was born." ) ) ;
