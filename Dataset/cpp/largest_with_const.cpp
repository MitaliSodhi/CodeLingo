...
//  largest_with_const.cpp   (c) 1998-2002  Kari Laitinen

/*  In this version of largest.cpp, keyword const is used
    to mark the arguments of a function as constants.  */

#include <iostream.h>

void search_largest_integer( const int  array_of_integers[],
                             const int  number_of_integers_in_array,
