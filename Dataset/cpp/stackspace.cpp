...
//  stackspace.cpp  (c) 1998-2002 Kari Laitinen

//  This program is like stack.cpp but this version outputs the 
//  address of the stack memory space always when the memory
//  space is increased
...
void  Stack::push( int item_to_the_stack )
{
   if ( number_of_items_on_stack  >=  current_stack_size  )
   {
      ...
      cout  <<  " STACK HAS GROWN. " << stack_memory_space << "  \n" ;
   }
