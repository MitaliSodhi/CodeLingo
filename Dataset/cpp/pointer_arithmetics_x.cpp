...
//  pointer_arithmetics_x.cpp  (c) 1998-2002 Kari Laitinen
...
int main()
{
   ...
   for (  an_integer_in_array   =  &array_of_integers[ 0 ]  ;
          an_integer_in_array  <=  &array_of_integers[ 4 ]  ;
          an_integer_in_array  ++  )
   {
