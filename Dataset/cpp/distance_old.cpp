//  distance_old.cpp  (c) 1997-2002 Kari Laitinen

/*  This program is like distance.cpp except that this
    uses old versions of the output manipulators.
    Therefore this can also be compiled with older C++
    compilers.  */
