...
class StrictRedis(object):
    ...
    def sentinel(self, *args):
        ...
        if args[0] in ['mains', 'subordinates', 'sentinels']:
            parse = 'SENTINEL_INFO'
        else:
            parse = 'SENTINEL'
    ...
    def sentinel_get_main_addr_by_name(self, service_name):
        ...
        return self.execute_command('SENTINEL', 'get-main-addr-by-name',
