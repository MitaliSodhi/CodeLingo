...
class Unabbreviator
{
   ...
   public string unabbreviate( int given_abbreviation_index )
   {
      return  common_abbreviations[ given_abbreviation_index ]
                                            .get_explanation_string() ;
   }
            
   public string unabbreviate( string given_abbreviation )
   {
...
class UnabbreviatorTester
{
   static void Main()
   {
      ...
      Console.Write( "\n " + test_unabbreviator.unabbreviate( "A.M." ) ) ;
      Console.Write( "\n " + test_unabbreviator.unabbreviate( "R.S.V.P." ) ) ;
      Console.Write( "\n " + test_unabbreviator.unabbreviate( "ASAP" ) ) ;
