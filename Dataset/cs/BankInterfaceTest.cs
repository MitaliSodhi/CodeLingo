...
//  BankInterfaceTest.cs  (c) 2003 Kari Laitinen
...
class BankInterfaceTest
{
   static void Main()
   {
      ...
      IMoneyStore  queen_account  = 
                       new  RestrictedAccount( "Freddie Mercury", 99999,
                                                 7000.00,  3000.00 ) ;
      queen_account.withdraw_money( 2500.00 ) ;

      //  The following statement is not possible because interface
      //  type MoneyStore does not specify method transfer_money_to().

//      queen_account.transfer_money_to( beatles_account, 500.00 ) ;
   }
}
