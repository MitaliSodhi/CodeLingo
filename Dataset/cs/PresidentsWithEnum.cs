...
//  PresidentsWithEnum.cs  (c) 2004 Kari Laitinen

//  Compilation: csc PresidentsWithEnum.cs Date.cs

//  This program works like Presidents.cs
//  An enum is used to represent status values in this version.
...
class  PresidentInfoApplication
{
   ...
   public PresidentInfoApplication()
   {
      ...
      president_table[ 42 ]  =  new
       ...
       "Republican", "01/20/2001", "01/20/2005", "Richard Cheney" ) ;
   ...
   public void search_president_by_name()
   {
      ...
      Status  array_search_status  =  Status.SEARCH_NOT_READY ;

      while ( array_search_status == Status.SEARCH_NOT_READY )
      {
         if ( president_table[ president_index ].get_president_name()
              .IndexOf( given_president_name )  !=  -1 )
         {
            array_search_status  =  Status.SEARCH_IS_SUCCESSFUL ;
         }
         else if ( president_index  >=  number_of_presidents_in_table - 1 )
         {
            array_search_status  =  Status.SEARCH_NOT_SUCCESSFUL ;
         }
         else
         {
            president_index  ++  ;
      ...
      if ( array_search_status  ==  Status.SEARCH_IS_SUCCESSFUL )
      {
   ...
   public void print_list_of_all_presidents()
   {
      ...
      while ( president_index  <  number_of_presidents_in_table )
      {
         ...
         if ( ( president_index  %  15 ) ==  0 )
         {
            ...
            string  useless_string  =  Console.ReadLine() ;
         }
      }
   }
