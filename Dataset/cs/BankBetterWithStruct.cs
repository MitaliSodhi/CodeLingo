...
//  BankBetterWithStruct.cs  (c) 2003 Kari Laitinen

//  www.naturalprogramming.com

//  This program works in the same way as BankBetter.cs
//  but in this program BankAccount is a struct, not a class.
//  The first parameter of the transfer_money_to() method
//  had to be defined as a ref parameter in order to make
//  the program work in the same way as BankBetter.cs
...
struct  BankAccount
{
   ...
   //  The first parameter must be a ref parameter because
   //  otherwise a copy of a BankAccount object is made to
   //  the stack memory. transfer_money_to() must be able to
   //  modify the BankAccount object created by the caller.

   public void transfer_money_to( ref  BankAccount  receiving_account,
...
class BankBetterWithStruct
{
   static void Main()
   {
      ...
      moon_walker_account.transfer_money_to( ref jazz_player_account,
                                             2222.22 ) ;
