...
class SearchMany
{
   ...
   static void Main( string[] command_line_parameters )
   {
      ...
      if ( command_line_parameters.Length  ==  4 )
      {
         strings_to_be_searched  =  new  string[ 3 ] ;
         strings_to_be_searched[ 0 ]  =  command_line_parameters[ 1 ] ;
         strings_to_be_searched[ 1 ]  =  command_line_parameters[ 2 ] ;
         strings_to_be_searched[ 2 ]  =  command_line_parameters[ 3 ] ;

         file_name_given_by_user  =  command_line_parameters[ 0 ] ;
      }
      else if ( command_line_parameters.Length  ==  3 )
      {
         strings_to_be_searched  =  new  string[ 2 ] ;
         strings_to_be_searched[ 0 ]  =  command_line_parameters[ 1 ] ;
         strings_to_be_searched[ 1 ]  =  command_line_parameters[ 2 ] ;

         file_name_given_by_user  =  command_line_parameters[ 0 ] ;
      }
      else if ( command_line_parameters.Length  ==  2 )
      {
